...
@routes.route('/download_pdf', methods=['GET'], endpoint='download_pdf')
def download_pdf():
...
# etc.
    ...
    # Ajustement de l'espacement après le logo
    pdf.ln(50)  # Réduction de 100 à 70
